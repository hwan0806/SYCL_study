#ifndef CPG_TRACK_NEW_HPP
#define CPG_TRACK_NEW_HPP
...
// end of namespace cpg::track_new

    [[nodiscard]]
    void* operator new (std::size_t size) 
    {
      return cpg::track_new::TrackNew::allocate(size, 0, "::new");
    }

    [[nodiscard]]
    void* operator new (std::size_t size, std::align_val_t align) 
    {
      return cpg::track_new::TrackNew::allocate(size, static_cast<size_t>(align), "::new aligned");
    }

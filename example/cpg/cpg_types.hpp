...
namespace cpg
{
    namespace types
    {
                ...
                const type_container<Type, Types...>& tc)
            {
                ...
                if constexpr(sizeof...(Types) == 0)
                {
                    if constexpr(type_container_c<Type>)
                        ...
                        os << smart_convert<CharType>(Cpg_GetTypeName(Type));
        ...
        */
        ...
        {
            os<< "< "<< Row << ", " << Column <<", " << Index <<", " << idx.size <<" >" ; return os;
        }
        ...
        {
            os<<" < " << Height <<", "<< Row << ", " << Column <<", "
                 << Index <<", " << idx.size <<" > " ; return os;
        }
